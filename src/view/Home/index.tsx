...
import Cart from '../../asserts/B.png';
        ...
        <div className="cart">
          ...
          <span>( {cart.length} ) - Itens</span>
            ...
            <section>
                { data.map((prod, index) =>( 
                  <div className="product-content" key={prod.id}>
                    <img alt="Uma cerveja lager pareceida com cerveja comercial." src={prod.photo} width="200" height="auto" />
                    <h4>{prod.name}</h4>
            ...
            <div className="principalForm">
                <form className="form" id="formCadastro" action="#" method="">
                        <input type="text" placeholder="name" id="txtNome" name="nome" />
